...
#Análise de correlação entre o número de alunos por docente e o IDH do município. Dados do PNUD 2010
...
# Apresente estatísticas descritivas do numero de alunos por docente nos municípios do Estado:
